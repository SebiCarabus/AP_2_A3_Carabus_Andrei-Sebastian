...
@Getter
@Setter
public class BunnyPanel extends GridPane {
    private String name;
    ...
    public void markVerdict(boolean verdict){
        if(verdict){
            this.status= MovementStatus.ESCAPED;
        }
        else {
            this.status= MovementStatus.CAUGHT;
        }
    ...
    public void disableMovement(){
        if(this.status.equals(MovementStatus.ESCAPED)||this.status.equals(MovementStatus.CAUGHT)){
            this.startButton.setDisable(true);
            this.stopButton.setDisable(true);
            return;
        }
    ...
    public BunnyPanel(String name,ExecutingController executingController){
